...
\begin{tikzpicture}[scale=0.8]
	...
	\node[inner sep=0pt,anchor=center] (C) at (12.3,-4) {\includegraphics[width=35pt]{../livrables/img/latex_monitor2.png}}
	node at (C.south) [below] {Clients} ;
	\node[inner sep=0pt,anchor=center] (C1) at (12.3,-2) {\includegraphics[width=35pt]{../livrables/img/latex_monitor.png}} ;
	\node[inner sep=0pt,anchor=center] (C2) at (12.3,0) {\includegraphics[width=35pt]{../livrables/img/latex_monitor.png}} ;
	\node[] at (11.4,-0.8) {\includegraphics[width=17pt]{../livrables/img/processor_32.png}} ;
	\node[] at (13.2,-0.8) {\includegraphics[width=17pt]{../livrables/img/processor_64.png}} ;
	\node[] at (11.4,-2.8) {\includegraphics[width=17pt]{../livrables/img/processor_32.png}} ;
	\node[] at (13.2,-2.8) {\includegraphics[width=17pt]{../livrables/img/processor_64.png}} ;
	\node[] at (13.3,-4.6) {\colorbox{white}{\makebox(12,12){\includegraphics[width=17pt]{../livrables/img/processor_64.png}}}} ;
	...
	\node[inner sep=0pt,anchor=center] (U1) at (13.5,0.1) {\includegraphics[width=15pt]{../livrables/img/latex_user.png}} ;
	\node[inner sep=0pt,anchor=center] (U2) at (13.5,-2.0) {\includegraphics[width=15pt]{../livrables/img/latex_user.png}} ;
	\node[inner sep=0pt,anchor=center] (U2) at (13.5,-3.8) {\includegraphics[width=15pt]{../livrables/img/latex_user.png}} ;
\end{tikzpicture}
\end{frame}
...
\begin{itemize}
\item Étude et recherche d'un nouveau langage de programmation
\item Le fichier de configuration (\textbf{paquito.yml}) :
	\begin{itemize}
		\item Étude et recherche d'un nouveau format
		\item Distinction de paquet binaire/libraire/indépendant
		\item Utilité et maintien des champs
	\end{itemize}
\end{itemize}
\end{frame}

\subsection{Aujourd'hui}
\begin{frame}{Distinction entre types de paquets}
	\begin{itemize}
		\item Démarcation par type de paquet dans la configuration de Paquito 2014
			\begin{figure}[h!]
				\begin{tikzpicture}
					\node[inner sep=0pt,anchor=center] (U) at (0, 0) {\includegraphics[width=20pt]{../livrables/img/latex_binary.png}} ;
					\node[inner sep=0pt,anchor=center] (U) at (1.5, 0) {\includegraphics[width=20pt]{../livrables/img/latex_book.png}} ;
					\node[inner sep=0pt,anchor=center] (U) at (3, 0) {\includegraphics[width=20pt]{../livrables/img/latex_processor.png}} ;
					\node[inner sep=0pt,anchor=center] (U) at (3, 0) {\includegraphics[width=15pt]{../livrables/img/red_cross.png}} ;
				\end{tikzpicture}
			\end{figure}
		\item Éventuellement pour générer plusieurs paquets à partir d'une même source
	\end{itemize}
\end{frame}
...
\begin{frame}{Modifications des champs}
	Nos propositions :
	\begin{itemize}
		%\item Remplacer \{BIN,LIB,IND\}PACKAGENAME par \{DEB,ARCH,RPM\}PACKAGENAME
		%\item Remplacer BUILDDEPENDS par \{DEB,ARCH,RPM\}BUILDDEPENDS
		%\item Remplacer \{BIN,LIB,IND\}RUNDEPENDS par \{DEB,ARCH,RPM\}RUNDEPENDS

...
\begin{itemize}
\item Choix d'un format et d'un langage
\item Le fichier de configuration (\textbf{paquito.yml}) :
	\begin{itemize}
		\item Recherche d'une nouvelle organisation
		\item Distinction de paquet binaire/libraire/indépendant
		\item Utilité et maintien des champs
	\end{itemize}
\item Compilation de Hello World pour Debian et Archlinux à partir d'un fichier de configuration
\end{itemize}
\end{frame}
\end{document}
...
\begin{itemize}
\item Rectifications du cahier des charges
\item Propositions de modifications sur le projet Paquito 2014
\item Ajout d'une dépendance optionnelle sur le projet \textit{Hello World}
\end{itemize}
\end{frame}
